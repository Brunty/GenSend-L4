...
//            return false;
    ...
    if ($error_number == 2002) {
        $error = '#' . ((string) $error_number) . ' - ' . __('The server is not responding') . ' ' . __('(or the localva MySQL server\'s socket is not correctly configured)');
