...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return '/Users/brunty/Sites/gensend-l4/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
...
namespace GenSend\Repositories;
...
{
    public function __construct(Securesend $securesend, String $string)
    {
    ...
    public function create(array $input = array())
    {
        try {
            ...
            $this->entity->url = $this->stringUtility->randomString();
...
namespace GenSend\Library\Utils;
...
{
    public static $characters = array('fullLowercase' => 'abcdefghijklmnopqrstuvwxyz', 'fullUppercase' => 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'nonSimilarLowercase' => 'abcdefghjkmnpqrtuvwxyz', 'nonSimilarUppercase' => 'ABCDEFGHJKMNPQRTUVWXYZ', 'standardNumbers' => '12346789', 'similar' => 'iIlLoOsS150', 'punctuation' => '!@#$%^&*?_~()-+:;');
    public static $defaultRandomOptions = array('nonSimilarLowercase' => true, 'nonSimilarUppercase' => true, 'standardNumbers' => true, 'punctuation' => false, 'similar' => false, 'checkForRuns' => false);
    public static $runsRegex = '/(.)\\1{3,}/';
    protected $characterSet = '';
    public static $phonetic = array('a' => 'alfa', 'b' => 'bravo', 'c' => 'charlie', 'd' => 'delta', 'e' => 'echo', 'f' => 'foxtrot', 'g' => 'golf', 'h' => 'hotel', 'i' => 'india', 'j' => 'juliet', 'k' => 'kilo', 'l' => 'lima', 'm' => 'mike', 'n' => 'november', 'o' => 'oscar', 'p' => 'papa', 'q' => 'quebec', 'r' => 'romeo', 's' => 'sierra', 't' => 'tango', 'u' => 'uniform', 'v' => 'victor', 'w' => 'whisky', 'x' => 'xray', 'y' => 'yankee', 'z' => 'zulu', '0' => 'zero', '1' => 'one', '2' => 'two', '3' => 'three', '4' => 'four', '5' => 'five', '6' => 'six', '7' => 'seven', '8' => 'eight', '9' => 'niner', '!' => 'exclamation mark', '?' => 'question mark', '$' => 'dollar', '%' => 'percent', '&' => 'ampersand', '*' => 'asterisk', '^' => 'caret', '~' => 'tilde', '(' => 'open braces', ')' => 'close braces', '-' => 'dash', '+' => 'plus', '@' => 'at', '#' => 'hash', '_' => 'underscore', '£' => 'pound', ':' => 'colon', ';' => 'semicolon');
    ...
    public function toPhonetic($string = '', $matchCase = true, $separator = ' - ')
    {
        ...
        foreach ($characters as $position => $character) {
            if (array_key_exists($character, self::$phonetic) && $matchCase) {
                $phonetic[$position] = self::$phonetic[$character];
            } elseif (array_key_exists(strtolower($character), self::$phonetic) && $matchCase) {
        ...
        return implode($separator, $phonetic);
    }
...
{
    public static $rules = array('length' => 'required|min:4|max:99|integer');
}
namespace GenSend\Validators;

class SendFormValidator extends Validator
{
    public static $rules = array('password' => 'required|max:255', 'views' => 'required|min:1|max:90|integer', 'days' => 'required|min:1|max:90|integer');
}
