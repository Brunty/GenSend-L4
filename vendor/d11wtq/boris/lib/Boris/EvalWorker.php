...
class EvalWorker {
  ...
  /**
   * Set localva variables to be placed in the workers's scope.
   *
   * @param array|string $local
   * @param mixed $value, if $localva is a string
   */
  ...
  public function start() {
    ...
    /* Note the naming of the localva variables due to shared scope with the user here */
    for (;;) {
      declare(ticks = 1);
