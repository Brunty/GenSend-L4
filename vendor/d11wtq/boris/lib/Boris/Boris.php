...
class Boris {
   ...
   * localva variables in the second argument.
   *
   * If the hook is a callback and needs to set any localva variables in the
   ...
   * of the callback, if any localva variables were set.
   *
  ...
  /**
   * Set a localva variable, or many localva variables.
   *
